...
command queue. Anything sent with `scripts/gb10/agentic/say.py` gets parsed by the local LLM
...
Then, from any other shell:
    ...
    python3 scripts/gb10/agentic/say.py "take the tray to room one"
...
print(
    '\nReady. From another shell: python3 scripts/gb10/agentic/say.py '
