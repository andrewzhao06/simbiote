...
from simbiote.teleop.camera_source import FrameSource, open_camera
from simbiote.teleop.hand_tracking import HandTracker
...
class TeleopSession:
    ...
    def _show_preview(self, frame, landmarks) -> None:
        ...
        cv2.imshow("Simbiote Teleop", frame)
