...
Mapping used tonight:
  ...
  - An EMA filter smooths both the arm target and the base velocity to
    damp landmark jitter (spec Part 8 risk: "Hand-tracking latency/jitter").
...
class IKBridge:
    ...
    def landmarks_to_action(self, landmarks: Optional[HandLandmarks]) -> RobotAction:
        ...
        prev_pose = self._last_action.arm_target_pose or Pose(position=(target_x, target_y, target_z))
