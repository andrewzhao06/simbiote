...
from factoryflow_mapper.ingest import CaptureValidationError, load_capture_bundle
...
def test_ingest_matches_files_by_frame_id(capture_dir: Path) -> None:
    ...
    assert capture.static_intrinsics == (1000.0, 0.0, 960.0, 0.0, 1000.0, 720.0, 0.0, 0.0, 1.0)
