"""Natural language -> validated tool calls — master doc 6b.5.
...
from factoryflow.agentic.llm_backend import LLMBackend, LLMError
from factoryflow.agentic.scene_query import SceneGraph
from factoryflow.agentic.tool_schema import (
    SchemaError,
    ToolCall,
    parse_tool_calls,
    tool_schema_text,
